...
import {fqParentName, getFqParentname,getConfigFilePath, configObjectPath, configPath} from "@pomegranate/plugin-tools";
import {template as objTmpl} from '../templates/config/objectConfiguration'
import {template as fnTmpl} from '../templates/config/functionConfiguration'
